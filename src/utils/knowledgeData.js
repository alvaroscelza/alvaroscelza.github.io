...
export const knowledgeData = [
    ...
    ['Amazon Simple Storage Service (S3)', 'Semi Senior', 'Cloud'],
    ['AWS Lambda', 'Semi Senior', 'Cloud'],
    ['Serverless', 'Semi Senior', 'Cloud'],
    ['Serverless Offline', 'Semi Senior', 'Cloud'],
    ['Amazon API Gateway (API Gateway)', 'Mid Level', 'Cloud'],
    ['Amazon CloudWatch (CloudWatch)', 'Mid Level', 'Cloud'],
    ['Amazon DynamoDB (DynamoDB)', 'Mid Level', 'Cloud'],
    ['AWS CodeDeploy', 'Junior', 'Cloud'],
    ['AWS CodePipeline', 'Junior', 'Cloud'],
    ['Amazon Simple Queue Service (SQS)', 'Junior', 'Cloud'],
    ...
    ['Terraform', 'Semi Senior', 'Miscellaneous'],
