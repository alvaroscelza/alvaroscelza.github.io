...
const versionOneDescription =
    <ExperienceDescription>
        ...
        <br/>
        Working along with another 2 developers, which means we do everything and thus, I have a valuable chance
        to learn from different areas!
    </ExperienceDescription>;

export {versionOneTechnologies, versionOneDescription};
